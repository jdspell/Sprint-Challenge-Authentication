...
Sessions allow an application to keep a user logged in without having to constantly verify their credentials.
1. What does bcrypt do to help us store passwords in a secure manner.
Bcrypt uses a secret to hash the password before it is saved to the database.
1. What does bcrypt do to slow down attackers?
Addeds a timer to failed password attempts to slow down attackers trying to brute force the hash.
